...
<% 
    int transport_id = Integer.parseInt( request.getParameter( "id" ) ); 
    TransportDAO dao = TransportDAO.getInstance();
    SingleTransport transport = dao.getSingleTransport( transport_id );
%>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-8 offset-lg-2">
                        <a href="transport-list.jsp?name=<%= transport.getType() %>">< <%= transport.getType() %></a>
                        <div class="page-title">
                            <h1><%= transport.getName() %></h1>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col-lg-8 offset-lg-2">
                        <div class="services-content-inner">
                            <p style="margin-bottom: 50px"><%= transport.getDescription() %></p>
                            <p>fare: Rs.<%= transport.getFare() %></p>
                            <p>route: <%= transport.getRoute() %></p>
                            <p>timing: <%= transport.getTiming() %></p>
